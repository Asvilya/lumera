...
install_node() {
  clear
  print_green "==============================================="
  print_green "    NODESRUN LUMERA NODE AUTO INSTALLER        "
  print_green "==============================================="
...
create_validator() {
  clear
  print_green "==============================================="
  print_green "     NODESRUN LUMERA VALIDATOR CREATOR         "
  print_green "==============================================="
...
restore_node() {
  clear
  print_green "==============================================="
  print_green "         NODESRUN LUMERA NODE RESTORE          "
  print_green "==============================================="
...
main_menu() {
  clear
  print_green "==============================================="
  print_green "       NODESRUN LUMERA NODE                    "
  print_green "==============================================="
